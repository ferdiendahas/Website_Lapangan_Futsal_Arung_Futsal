...
public class PanelManajemenLapangan extends JPanel {
    ...
    public PanelManajemenLapangan() {
        ...
        setBackground(new Color(0, 128, 0)); // Selaras PanelBooking
        ...
        // ================== PANEL ATAS (Filter Tanggal & Button) ==================
        JPanel panelAtas = new JPanel(new FlowLayout(FlowLayout.LEFT));
        panelAtas.setBackground(new Color(255, 215, 0)); // Gold
        JLabel lblTanggal = new JLabel("Tanggal:");
        lblTanggal.setFont(new Font("Segoe UI", Font.BOLD, 14));
        lblTanggal.setForeground(new Color(18, 45, 26));
        panelAtas.add(lblTanggal);
        ...
        btnRefresh.setBackground(new Color(41, 84, 35));
        btnRefresh.setForeground(Color.YELLOW);
        btnRefresh.setFont(new Font("Segoe UI", Font.BOLD, 14));
        btnRefresh.setBorder(BorderFactory.createLineBorder(new Color(41, 84, 35), 1, true));
