...
public class DashboardAdmin extends javax.swing.JFrame {
    ...
    private final Color selectedBg = new Color(44, 84, 163);
    private final Color glossy = new Color(38, 74, 140, 190);
    /**
     * Creates new form DashboardAdminn
     */
    public DashboardAdmin() {
        ...
        // GridLayout(baris, 1, hgap, vgap) - buat proporsional
        ...
        for (int i = 0; i < menuData.length; i++) {
            ...
            menuButtons[i].setFont(new Font("Segoe UI", Font.BOLD, 15)); // Font lebih kecil dan tebal
            ...
            menuButtons[i].setPreferredSize(new Dimension(50, 18)); // tinggi fix
            int finalI = i;
            menuButtons[i].addActionListener(e -> showCard(menuData[finalI][2]));
